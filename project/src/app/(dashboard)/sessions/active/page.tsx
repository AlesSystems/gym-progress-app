          ...
          {session.exercises.length === 0 ? (
            <div className="rounded-[2rem] md:rounded-[2.5rem] border-2 border-dashed border-border bg-card/20 p-10 md:p-20 text-center backdrop-blur-sm group hover:border-primary/30 transition-all duration-500">
              ...
              <button
                ...
                className="rounded-2xl bg-primary px-6 md:px-8 py-3 text-sm md:text-base font-bold text-primary-foreground hover:bg-primary/90 hover:scale-[1.05] active:scale-[0.95] transition-all shadow-xl shadow-primary/20"
              >
                + Add Exercise
              </button>
            </div>
